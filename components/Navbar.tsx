          ...
          {links.map((link) => (
            <li key={link.label}>
              <a
                ...
                className="tx-serif-light text-[11px] uppercase tracking-[0.14em] text-[#F0B537] transition-all duration-300 border-b border-transparent hover:border-brand-gold pb-0.5"
              >
                {link.label}
              </a>
            </li>
          ...
          {links.map((link) => (
            <li key={link.label}>
              <a
                ...
                className="tx-serif-light text-[12px] uppercase tracking-[0.14em] text-[#F0B537] transition-all duration-300"
              >
                {link.label}
              </a>
            </li>
